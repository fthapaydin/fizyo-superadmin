...
import { ShieldCheck, Lock, Mail, Loader2, ArrowRight, LayoutDashboard, Building2, Users, Eye, EyeOff } from 'lucide-react';
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-12 pl-11 pr-11 rounded-xl bg-white border border-slate-200 text-slate-900 text-[14px] focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 outline-none transition-all placeholder:text-slate-400 font-medium shadow-2xs"
                />
                <button
                  type="button"
