...
import { QrCode, Printer, Download, Copy, Check, X, Smartphone, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-3xl shadow-2xl max-w-lg w-full p-6 md:p-8 z-10 animate-in zoom-in-95 duration-200 border border-gray-100 max-h-[92vh] overflow-y-auto font-[Inter]">
        ...
        <div 
          ref={printRef}
          className="bg-gradient-to-b from-slate-50 via-white to-indigo-50/40 border-2 border-indigo-600/30 rounded-3xl p-6 text-center shadow-md relative overflow-hidden"
        >
          {/* Clinic Brand Header */}
          <div className="flex flex-col items-center gap-2 mb-4">
            {clinic?.logo_url ? (
              ...
              <div 
                ...
                style={{ backgroundColor: clinic?.theme_color || '#4f46e5' }}
              >
            ...
            <div>
              ...
              <p className="text-[11px] text-indigo-700 font-semibold tracking-wide uppercase">Online Randevu Standı</p>
            </div>
          </div>

          {/* Slogan */}
          <div className="bg-indigo-600 text-white rounded-2xl py-2 px-3 mb-4 shadow-sm">
          ...
          {/* Stand Footer */}
          <div className="mt-4 pt-3 border-t border-indigo-100 text-[10px] text-gray-400 font-medium flex items-center justify-between px-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 mt-5">
          <button
            onClick={handlePrint}
            className="h-10 px-3 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-[12px] font-semibold flex items-center justify-center gap-1.5 transition-all shadow-sm cursor-pointer"
          ...
          <button
            ...
            className="h-10 px-3 rounded-xl border border-indigo-200 bg-indigo-50/80 hover:bg-indigo-100 text-indigo-800 text-[12px] font-semibold flex items-center justify-center gap-1.5 transition-all cursor-pointer"
          >
            {copied ? <Check size={14} className="text-indigo-600" /> : <Copy size={14} />}
